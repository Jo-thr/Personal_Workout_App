        ...
        works: [
          {
            ...
            duration: { time: 30, mesure: "s", object: "de travail" },
            series: { number: "2", object: "fois" },
          },
          {
            id: 2,
            ...
            duration: { time: 15, mesure: "s", object: "de travail" },
            series: { number: "2", object: "fois" },
          },
          {
            id: 3,
      ...
      },
      {
        ...
        works: [
          ...
          },
          {
            ...
            duration: { time: "1min 30", object: "de travail" },
            repetition: { number: "50", object: "répétitions de chaque côté" },
            rest: { time: "30s", object: "de repos" },
            series: { number: "4", object: "séries" },
          },
          {
            id: 5,
            ...
            repetition: {
              number: "10",
              object: "répétitions de chaque côtés + 10s de battements",
            },
            rest: { time: "30s", object: "de repos" },
            series: { number: "4", object: "séries" },
          },
          {
            ...
            repetition: {
              number: "20",
              object: "répétitions + répétions dynamiques",
            },
            series: { number: "4", object: "séries" },
          },
          {
          ...
          },
          {
            ...
            repetition: "5 répétitions de chaque côtés",
            rest: "30s de repos",
            series: "4 fois",
          },
          {
            ...
            duration: { time: "3min", object: "de travail" },
          },
          {
            id: 10,
            name: "Jump Dynamique",
            ...
            repetition:
              "30 répétitions de chaque côtés + descendre au max toutes les 10 répétitions",
            rest: "15s de repos",
            series: "4 fois",
          },
          {
          ...
          },
          {
            ...
            duration: { time: "30s", object: "de travail" },
            rest: "1min de repos",
            series: "3 fois à 2 jambes + 3 fois à 1 jambe",
          },
          {
            id: 13,
            name: "Repos",
          ...
          },
          {
            ...
            duration: { time: "1min", object: "de travail" },
          },
          {
            id: 16,
          ...
          },
          {
            ...
            repetition:
              "4s de tipping + 4 grands pas + 1 grand saut vertical à faire 6 fois de chaque côtés",
            rest: "30s de repos",
            series: "4 fois",
          },
        ],
        ...
        works: [
          {
            ...
            duration: { time: "30s", object: "chaque pied" },
            series: "3 séries",
          },
          {
            id: 2,
          ...
          },
          {
            ...
            duration: { time: "30s", object: "chaque jambe" },
            series: "3 séries",
          },
          {
            id: 5,
          ...
          },
          {
            ...
            duration: { time: "15min", object: "de travail" },
            series: "1 série",
          },
        ],
      },
        ...
        works: [
          {
            ...
            duration: { object: "Alterner Haut <-> Bas" },
            series: "10 séries",
          },
          {
            id: 2,
            ...
            duration: { object: "Alterner Gauche <-> Droite" },
            series: "20 séries",
          },
          {
            id: 3,
            ...
            duration: { object: "Alterner Gauche <-> Droite" },
            repetion: "10 répétitions à Gauche + 10 répétitions à Droite",
            series: "1 séries",
          },
          {
            id: 4,
            ...
            duration: { object: "Alterner Intérieur <-> Extérieur" },
            series: "15 séries",
          },
          {
            id: 5,
            ...
            repetition: "5 répétitions sur chaque pied",
            series: "4 séries",
          },
        ],
      },
    ...
    sessions: {
      ...
      works: [
        ...
        },
        {
          ...
          description: (
            <>
              On retrouve des exercices afin de renforcer la bandelette tibiale
              pour pouvoir avoir un arrêt et une propulsion beaucoup plus
              dynamique.
              <br />
              Il est important de travailler ces petits muscles qui jouent
              également un rôle favorisant la réussite au Dunk.
              <br />
              <br />
              Il faut trouver un mur ou une surface dure sur lequel ou laquelle
              tu peux t’appuyer. Tu mets tes pieds à 1 m devant le mur et tu
              mets tes fesses appuyées contre le mur. Tu peux également décoller
              tes fesses pour rendre l’exercice beaucoup plus dur.
              <br />
              Le but est de remonter la pointe de pieds vers le haut de façon
              ...
              <br />
              Nous ciblons le muscle à l’avant du tibia appelé la bandelette
              tibiale qui nous permettra de nous arrêter et de nous propulser de
        ...
        },
        {
          ...
          description: (
            <>
              Il est bien de travailler l’avant du tibia tout en prenant en
              compte ce qu’il se passe à l’arrière. Ainsi nous allons renforcer
              le mollet en sachant que ce muscle contribue énormément lorsque
              l’on saute.
              <br />
              <br />
              Il nous suffit de trouver un escalier ou alors une surface solide
              où nous allons pouvoir mettre notre pointe de pied et laisser
              notre talon dans le vide. L’essentiel est de monter le plus vite
              possible tout en descendant lentement et ainsi de suite.
              <br />
              Il faut descendre à son maximum le talon dans le vide et faire en
              sorte que cela ne touche pas le sol. Il ne faut pas hésiter à
              prendre une surface solide de sorte à ce que le talon ne touche
              pas le sol en descendant.
            </>
          ),
          ...
          repetition: "15 répétitions de chaque côtés",
          series: "5 fois",
        },
        {
          id: 4,
          ...
          description: (
            <>
              ...
              <br />
              <br />
              Tu ne dois pas te laisser écraser au sol lors de ta réception. Il
              est important d’avoir une réaction explosive et dynamique.
              <br />
              <br />
              Dans ta tête tu peux t’imaginer que le sol est chaud correspondant
              à de la lave, cela te permettra d’avoir une réaction beaucoup plus
          ...
          duration: "1min 30 de travail",
          repetition: "10 répétitions de chaque côtés",
          rest: "30s de repos",
          series: "5 fois",
        },
        {
          ...
          description: (
            <>
              ...
              derrière le talon d’Achille. C’est donc la jambe qui est derrière
              ce talon qui va venir pousser ton pied en direction du sol.
              Simultanément le pied qui se fait emmener vers le sol vient mettre
              une résistance afin de travailler tes ischio-jambiers ; à toi de
              gérer la résistance.
              <br />
              <br />
              Une fois ce travail terminé tu enchaînes directement en te mettant
              sur le dos. Tu dois être le plus droit possible et tes talons
              doivent toucher le sol. Tu viens décoller les fesses puis réaliser
              de petits battements avec tes jambes sans que tes fesses touchent
              le sol. Tu es donc en appui seulement avec le haut de ton dos et
              ainsi les talons viennent faire des battements afin de faire
          ...
          repetition: "10 répétitions de chaque côtés + 10s de battements",
          rest: "30s de repos",
          series: "5 fois",
        },
        {
          ...
          description: (
            <>
              Nous allons travailler les cuisses et plus précisément les
              quadriceps. Il serait préférable que tu trouves une petite cale à
              mettre sous le talon pour te permettre d’avoir plus de mobilité au
              niveau de ta cheville. En effet tout le monde n’a pas la cheville
              souple.
              <br />
              <br />
              C’est pourquoi, pour réaliser correctement cet exercice et éviter
              de compenser par un autre endroit de ton corps, je te conseille de
              mettre une cale sous ton pied. Si tu es dans ce cas précis et même
              si tu n’es pas dans ce cas là cela te permettra de cibler beaucoup
              plus ton quadriceps.
              <br />
              <br />
              Tu vas venir te mettre sur une jambe, étendre l’autre jambe sans
              qu’elle touche le sol. Tu vas descendre de sorte à ce que ton
              genou dépasse tes pieds. Fais attention que ton genou ne part pas
              sur ta droite ni sur ta gauche mais qu’il reste bien dans l’axe.
              <br />
              <br />
              Surveille également que ta hanche ne s’affaisse pas et de bien la
              garder droite. Une fois ta descente lente réalisée, tu peux
              ensuite remonter de façon dynamique lorsque ton nombre de séries
              est atteint. Tu effectues de nouveau la série demandée mais, cette
              fois-ci, tu descends rapidement et tu remontes rapidement
              également.
              <br />
              <br />
              Tout en gardant ton autre jambe tendue sur le talon qui touchera
          ...
          repetition: "20 répétitions + 10 répétions dynamiques",
          series: "5 fois",
        },
        {
          id: 7,
        ...
        },
        {
          ...
          description: (
            <>
              ...
              dynamiser tout cela et de transformer cette énergie en
              explosivité.
              <br />
              <br />
              Le but est de placer tes appuis largeur de tes épaules. Tu viens
        ...
        },
        {
          ...
          description: (
            <>
              ...
              <br />
              Pour que cet exercice soit vraiment bien réalisé pour ton saut
              vertical, tu vas mettre une jambe devant toi et l’autre surélevée
              sur une table ou une chaise en fonction de ce que tu as à
              proximité.
              <br />
              La jambe qui est devant ne doit pas être trop proche du support
              mais plutôt assez loin comme sur la vidéo ou sur les photos.
              ...
              amortissant. Tu ressors ensuite pour effectuer une nouvelle série
              de 10 sauts et de la même manière au 10ème tu viens descendre
              lentement et au plus bas. Tu fais de nouveau une série de 10 sauts
              pour réaliser la même chose. Au total tu auras exécuté 30 séries.
            </>
          ),
          image: {
            src: "",
        ...
        },
        {
          ...
          description: (
            <>
              ...
              <br />
              <br />
              Installe toi de façon assise sans que le dos ni les pieds touchent
              le sol. Tu dois être en équilibre et les pieds vont pousser
              simultanément en avant. Le haut de ton corps va venir chercher en
              arrière afin d’être équilibré. Tu viens ensuite ramener tes jambes
              au plus proche de toi sans toucher le sol. Puis tu ramènes
              également ton corps vers l’avant et ainsi de suite.
              <br />
              Tu peux t’aider de tes mains pour avoir un meilleur équilibre sans
              qu’elles touchent le sol. Il est intéressant de ramener les mains
              vers soi lorsque l’on pousse avec les jambes et de détendre les
              mains lorsque l’on ramène les jambes.
              <br />
              <br />
              Une fois ta première série réalisée, enchaîne directement en
              gardant l’équilibre et cette fois-ci tu dois battre des pieds
        ...
        },
        {
          ...
          description: (
            <>
              ...
              <br />
              Il est important lors de tout contact avec les escaliers
              d’imaginer que le sol correspond à de la lave ou qu’il est chaud.
              <br />
              Tu dois remonter le plus vite possible dynamiquement et passer à
              la marche suivante. N’oublie surtout pas la respiration qui te
              permettra d’être plus performant.
              ...
              <br />
              Cette fois-ci tu sauteras sûrement moins de marche. L’idée est de
              ne pas s’écraser sur une marche et de rebondir de façon explosive
              en restant le même.
            </>
          ),
          image: {
          ...
          duration: "30s de travail",
          rest: "1min de repos",
          series: "4 fois à 2 jambes + 4 fois à 1 jambe",
        },
        {
          id: 13,
          name: "Repos",
        ...
        },
        {
          ...
          description: (
            <>
              Le gainage est mis en avant lors d’un Dunk. Nous allons le
              travailler ici en mouvement de sorte à developper d’autres groupes
              musculaires en même temps.
              <br />
              <br />
              Nous allons nous positionner sur les mains avec les pieds le plus
              loin et les jambes tendues. Fais attention à ne pas avoir les
              fesses trop baissées ou trop montées.
              <br />
              <br />
              Le but est de maintenir cette position tout en ramenant le genou
              au niveau de la poitrine opposé à notre jambe tout en alternant la
        ...
        },
        {
          ...
          description: (
            <>
              Il sera vu un enchaînement de mouvements nous rapprochant au plus
              près d’une situation de saut lors d’un Dunk.
              <br />
              En étant largeur des épaules, tu viens réaliser un tipping
              c’est-à-dire courir sur place très rapidement en ayant les pieds
              le plus proche du sol. Tu maintiens cette position durant 4
              secondes et ensuite tu réalises 4 grands pas au plus loin
              possible. C’est seulement au quatrième que tu viens faire un plus
              petit pas pour pouvoir sauter le plus haut possible à une jambe.
              Tu alterneras sur le saut à la fin la jambe droite puis la jambe
              gauche sur cet exercice. Il faut réaliser 6 fois avant le repos.
            </>
          ),
          image: {
            src: "",
      ...
      works: [
        {
          ...
          description: (
            <>
              Place ton pouce entre l’orteil et les autres doigts de pieds puis
              en même temps tu ramènes le pied vers toi. Il faudra le tirer vers
              l’extérieur.
            </>
          ),
          image: {
        ...
        },
        {
          ...
          description: (
            <>
              Il suffit de placer ton pied derrière toi sur la pointe des pieds
              et le talon doit se diriger vers l’extérieur.
            </>
          ),
          image: {
            src: "",
        ...
        },
        {
          ...
          description: (
            <>
              Saisis ton pied, place-le contre le mur pendant que ton genou
              touche le sol. Le but est de rapprocher ton genou le plus près du
              mur et place ton autre jambe devant toi pour pouvoir te relever au
              maximum afin d’être droit. L’objectif est de ne pas forcer.
              <br />
              Si cela est compliqué, alors, n’hésite pas à éloigner le genou du
              mur.
            </>
          ),
          image: {
        ...
        },
        {
          ...
          description: (
            <>
              Laisse tes pieds joints, fais en sorte de tendre tes jambes sans
              plier les genoux et enroule toi en essayant de toucher le sol avec
              tes doigts. Si tu réussis alors n’hésite pas de toucher avec la
              paume de la main, et plus encore si besoin, lorsque tu remontes,
              déroule toi de façon lente.
            </>
          ),
          image: {
            src: "",
        ...
        },
        {
          ...
          description: (
            <>
              ...
              L'autre jambe est tendue avec le pied au sol pour maintenir
              l'équilibre. Garde ton tronc gainé et ta nuque dans l'alignement
              du tronc. Tu peux placer tes mains sur tes hanches ou derrière ton
              dos par exemple.
              <br />
              Bascule ton buste en avant tout en gardant la jambe tendue. Aide
              toi également en essayant de pousser les fesses en arrière.
              <br />
              Relâche doucement l'étirement une fois terminée. Ne courbe pas le
              dos tout le long de l'étirement.
            </>
          ),
          image: {
            src: "",
        ...
        },
        {
          ...
          description: (
            <>
              Assis au sol, tend une jambe vers l’arrière et plie l’autre sur le
              flanc devant toi. Tout en expirant descend le buste lentement en
              direction du genou. Aide-toi des deux bras pour assurer ta
              stabilité.
              <br />
              Maintiens la position 30 secondes puis change de jambe et répète
              le mouvement.
        ...
        },
        {
          ...
          description: (
            <>
              Tu es assis en tailleur, les plantes de pieds se font face et sont
              en contact. Tu dois attraper tes pieds avec les mains et repousser
              tes genoux vers le bas avec tes coudes.
              <br />
              Le bas du dos doit rester droit et ne pas s'arrondir. L'étirement
              se fait pendant le temps expiratoire en soufflant profondément et
              lentement.
            </>
          ),
          image: {
        ...
        },
        {
          ...
          description: (
            <>
              Place ta jambe le plus tendue possible en arrière et une autre
              jambe devant pliée. Tu dois être en position assise sur tes pieds.
              Maintiens cette position et penche ton corps vers l’arrière afin
              d’étirer l’ilio-psoas.
            </>
          ),
          image: {
            src: "",
        ...
        },
        {
          ...
          description: (
            <>
              Pose le pied gauche à son opposé jusqu’à avoir une rotation au
              niveau des lombaires. Laisse ton bassin suivre mais fixe bien tes
              deux épaules au sol.
            </>
          ),
          image: {
        ...
        },
        {
          ...
          description: (
            <>
              Posées contre un mur à la verticale, jambes gonflées, lourdes et
              parfois douloureuses se voient donner un second souffle dans cette
              position. Elle est en effet très efficace pour réamorcer la pompe
              veineuse. Résultat ? Le sang circule mieux dans les veines et ne
              stagne plus dans les chevilles et les pieds.
              <br />
              Évite les sensations de jambes lourdes et permet de récupérer plus
              vite. La récupération et la regénération de tes cellules
              permettent d’enchaîner les efforts.
            </>
          ),
          image: {
      ...
      works: [
        ...
        },
        {
          ...
          description: (
            <>
              Se mettre assis, le dos droit, ramener les pieds vers soi, en
              pliant les genoux de sorte à ce que tes genoux soient du même côté
              tout en effectuant une rotation du bassin.
              <br />
              Ensuite si tes genoux sont du côté droit passe-les du côté gauche
              en alternant tout cela et en essayant de garder ton haut du corps
              droit.
            </>
          ),
          image: {
          ...
          duration: "Alterner Gauche <-> Droite",
          series: "20 séries",
        },
        {
          id: 3,
          ...
          description: (
            <>
              ...
              bien de sorte à avoir un angle à 90°. Le pied de devant est à plat
              et celui de derrière sur la pointe. Rien d’autre doit toucher le
              sol à part ta main pour avoir de l’équilibre.
              <br />
              Ensuite, avec une main, aller chercher au-dessus de toi tout en
              tournant ton bassin, puis change de main.
            </>
        ...
        },
        {
          ...
          duration: "Alterner Intérieur <-> Extérieur",
          series: "15 séries",
        },
        {
          id: 5,
          ...
          description: (
            <>
              ...
              qui est très intéressant sur la mobilité de la cheville. Le but
              est de descendre ton talon le plus bas possible. C’est pour cela
              qu’un support solide où tu peux mettre la pointe de pied et ainsi
              descendre le talon le plus bas est important, remonte par la suite
              et redescends.
            </>
          ),
          image: {
